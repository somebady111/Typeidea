...
class PostAdminForm(forms.ModelForm):
    ...
    #     widget=autocomplete.ModelSelect(url='category-autocomplete'),
    #     label='分类',
    # )
    # tag = forms.ModelMultipleChoiceField(
    #     queryset=Tag.objects.all(),
    #     widget=autocomplete.ModelSelectMultiple(url='tag-autocomplete'),
    #     label='标签',
    # )
    # # twidget=CKEdiorUploadingWidget(),
    # content_ck = forms.CharField( label='正文', required=False)
